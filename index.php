<?php
/*
  index.php: Página inicial do site MimosShopBrasil.
...
<head>
  ...
  <meta name="twitter:title" content="Mimos Shop Brasil – Melhores Ofertas e Descontos do Dia">
  <meta name="twitter:description" content="Compare preços das principais lojas, encontre descontos exclusivos e economize todos os dias com o comparador Mimos Shop Brasil.">
  <meta name="twitter:image" content="https://mimosshopbrasil.com/og_banner.png">
  ...
  <script type="application/ld+json">
  {
    ...
    "url": "https://mimosshopbrasil.com/",
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://mimosshopbrasil.com/produtos.php?search={search_term_string}",
